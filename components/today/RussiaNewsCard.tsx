...
export function getRussiaNewsTopicBadgeClass(topic: string): string {
  if (topic === '정치') return 'bg-rose-100 text-rose-900 dark:bg-rose-900/40 dark:text-rose-100'
  if (topic === '사회') return 'bg-blue-100 text-blue-900 dark:bg-blue-900/40 dark:text-blue-100'
  if (topic === '경제') return 'bg-emerald-100 text-emerald-900 dark:bg-emerald-900/40 dark:text-emerald-100'
  if (topic === '문화') return 'bg-amber-100 text-amber-900 dark:bg-amber-900/40 dark:text-amber-100'
  if (topic === '날씨') return 'bg-cyan-100 text-cyan-900 dark:bg-cyan-900/40 dark:text-cyan-100'
